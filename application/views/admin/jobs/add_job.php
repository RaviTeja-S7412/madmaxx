                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card-header cheader">
                                <div class="row">
                                    <div class="col-md-6">
                                    <h4 class="card-title ctitle"><i class="mdi mdi-account-plus"></i> Add Job</h4>
                                    </div>
...
<div class="row mt-3">
    <div class="col-md-4">
        ...
        <input type="number" name="positions" min="1" class="form-control" required/>
    </div>
    <div class="col-md-4">
        URL
...
<div class="row mt-3">
    <div class="col-md-6">
        Requirement Skills
        <textarea id="long_desc" class="form-control p-0 summernote" name="long_desc"></textarea>
    </div>
    <div class="col-md-6">
        Additional Information
        <textarea id="add_info" class="form-control p-0 summernote" name="add_info"></textarea>
    </div>
</div>
...
<div class="row mt-3">
    ...
    <div class="col-md-2 text-right">
        <input type="submit" name="submit" class="btn btn-primary" value="ADD JOB" id="sbtn"/>
    </div>
</div>
                            </form>
                            </div>
...
$(function(){
    $("#createJob").on('submit', function(e){
        ...
        $.ajax({
            url:"<? echo base_url(); ?>admin/jobs/insert",
            data:fdata,
            type:"post",
            dataType:"json",
            beforeSend: function(){
            ...
            success: function(data){
                ...
                if(data.Status == 'Success'){
                    ...
                    setTimeout(()=>{
                        $("#smsg").hide();
                        $("#createJob")[0].reset();
                        $("#add_info").summernote('reset');
                        $("#long_desc").summernote('reset');
                    },2000);
                }
            },
